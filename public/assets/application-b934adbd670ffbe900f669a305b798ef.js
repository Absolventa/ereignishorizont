...
(function() {
  $(document).ready(function() {
    return $('#alarm_action').change(function() {
      var selected;
      selected = $('#alarm_action option').filter(':selected').text();
      if (selected === 'Email') {
        return $('.for-email').show();
      } else {
        return $('.for-email').hide();
      }
    });
  });
...
(function() {
  $(document).ready(function() {
    $('#expected_event_started_at').datepicker({
      dateFormat: "yy-mm-dd"
    });
    $('#expected_event_ended_at').datepicker({
      dateFormat: "yy-mm-dd"
    });
    $('#toggle_weekday_selection').click(function(e) {
      var selector;
      e.preventDefault();
    ...
    return $('#available_incoming_event_titles').change(function() {
      $('#expected_event_title').val($(this).val());
      return $('#expected_event_title').focus();
    });
  });
...
(function() {
  $(document).ready(function() {
    if ($('#send_invitation').is(':checked') === true) {
      $('.password').hide();
    }
    return $('#send_invitation').change(function() {
